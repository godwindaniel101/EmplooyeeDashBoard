                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="number" type="number" class="form-control{{ $errors->has('phoneNo') ? ' is-invalid' : '' }}" name="phoneNo" value="{{ old('phoneNo') }}" required>
                        ...
                        @if(isset($referralById))
                        <div class="form-group row">
                            <label for="referredBy" class="col-md-4 col-form-label text-md-right">{{ __('Referred By') }}</label>
                                <div class="col-md-6">
                                    <input id="referralName" type="text" class="form-control" name="referralName" value="{{$referralName}}" disabled>
                                </div>
                            </div>
                                <input id="referralById" type="hidden" value="{{$referralById}}" name="referralById" >
                        @endif
